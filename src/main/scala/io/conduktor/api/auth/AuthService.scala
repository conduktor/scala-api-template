...
object UserAuthenticationLayer {
  ...
  object AuthService {
    ...
    val live: ZLayer[Has[Auth0Config] with Clock, Nothing, Has[Service]] =
      ZLayer.fromServices[Auth0Config, Clock.Service, Service] { // [Auth0Config, Clock.Service, Has[Service]]
